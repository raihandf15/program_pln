...
<body style="background:url('../images/bg_3.jpg');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 5px;">
								<img src="../images/logo_2.png" alt="logo" class="logo" width="90px">
							</div>
						...
						<div class="panel-footer">
							<center>&copy;<?php echo date("Y"); ?> - Raihan Dika Febriansyah</center>
						</div>
						<!-- end footer -->
					</div>
				</div>
