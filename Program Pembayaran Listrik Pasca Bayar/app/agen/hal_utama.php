...
<body>
				...
				<div class="navbar navbar-fixed-top navbar-default">
					<div class="navbar-header">
						<a href="?menu=home" class="navbar-brand" style="margin-top: -23px;">
							<img alt="Brand" src="../images/logo_listrik.png" width="150px" >
						</a>
					</div>
	...
	<footer class="container-fluid bg-4 text-center">
		<p>
		  	<strong>Copyright&nbsp;&copy;&nbsp;2023 <a target="_blank" href="https://www.instagram.com/rmdnzdn/">Raihan Dika Febriansyah</a>.</strong>&nbsp;
		  	<br>
